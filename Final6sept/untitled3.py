...
# -*- coding: utf-8 -*-
"""
Created on Sun Sep  3 18:12:17 2023
...
class PersonalityTypeApp:
    def __init__(self, root):
        ...
        self.input_bg_image = Image.open("/Users/batfleck06/Documents/Final Project/Notebooks/New test/AppFinal/wd.jpg")
        self.result_bg_image = Image.open("/Users/batfleck06/Documents/Final Project/Notebooks/New test/AppFinal/wd.jpg")

        # Create a PhotoImage object from the background images
        self.input_bg_photo = ImageTk.PhotoImage(self.input_bg_image)
        self.result_bg_photo = ImageTk.PhotoImage(self.result_bg_image)

        # Create labels for input and result windows with background images
        self.input_bg_label = ttk.Label(self.root, image=self.input_bg_photo)
        self.input_bg_label.place(relwidth=1, relheight=1)
    ...
    def display_predictions(self, num_predictions=3):
        ...
        result_bg_label = ttk.Label(result_window, image=self.result_bg_photo)
        result_bg_label.place(relwidth=1, relheight=1)
