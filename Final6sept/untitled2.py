...
# -*- coding: utf-8 -*-
"""
Created on Sun Sep  3 18:05:54 2023
...
class PersonalityTypeApp:
    def __init__(self, root):
        ...
        background_image = Image.open("wd.jpg")
    ...
    def display_predictions(self, num_predictions=3):
        ...
        # Make the result window full-screen
        ...
        openai_text = tk.Text(openai_frame, height=10, width=40, wrap=tk.WORD)
        ...
        ml_text = tk.Text(ml_frame, height=10, width=40, wrap=tk.WORD)
