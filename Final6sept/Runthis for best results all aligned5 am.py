...
class PersonalityTypeApp:
    ...
    def display_predictions(self, num_predictions=3):
        ...
        ml_graph_frame = ttk.Frame(top_frame, width=300, height=300)
        ...
        treemap_canvas.get_tk_widget().grid(row=3, column=3, padx=15, pady=0, sticky ="nsew")
        ...
        # Create a frame for ML prediction images
        ...
        ml_images_label = ttk.Label(ml_images_frame, text="ML Prediction Images", font=("Arial", 12))
        ...
        # Calculate the number of columns and rows for the image grid
